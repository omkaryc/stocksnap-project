...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedUsersAndProducts() {
        ...
        User owner = userRepository.findByEmail("owner@stocksnap.com")
        ...
        userRepository.findByEmail("customer@stocksnap.com")
                .orElseGet(() -> userRepository.save(User.builder()
                        .name("Asha Customer")
        ...
        if (store.getLatitude() == null || store.getLongitude() == null) {
            store.setLatitude(18.5970);
            store.setLongitude(73.7898);
        ...
        if (productRepository.count() == 0) {
            ...
            productRepository.save(Product.builder()
                    ...
                    .brand("Aashirvaad")
                    .description("Whole wheat flour pack")
                    .price(new BigDecimal("285"))
                    .stockQuantity(12)
            ...
            productRepository.save(Product.builder()
                    ...
                    .productName("iPhone Charger 20W")
