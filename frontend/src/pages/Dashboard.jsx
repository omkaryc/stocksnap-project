...
export default function Dashboard() {
  ...
  return (
    <div className="container mt-5">
      ...
      {profile && (
        <div className="alert border mb-4" style={{ background: 'var(--primary-tint)', borderColor: 'var(--primary-tint)', color: 'var(--primary-dark)' }}>
      ...
      {user?.role === 'CUSTOMER' && (
        <Reveal>
          <div className="card"><div className="card-body"><h4>Customer dashboard</h4><p className="mb-0 text-muted">You can search products, compare stores, and save favorites.</p></div></div>
        </Reveal>
      )}
